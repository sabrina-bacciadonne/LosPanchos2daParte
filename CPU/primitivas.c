...
t_valor_variable obtenerValorCompartida(t_nombre_compartida variable);
	...
	//void imprimirTexto(char*texto); no estaban en el parser.h
	//void entradaSalida(t_nombre_dispositivo dispositivo,int tiempo); no reconoce t_nombre_dispositivo
	void finalizar();
